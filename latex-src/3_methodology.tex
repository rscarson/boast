...
\label{sec:ps_experiment1}
    ...
    \subsubsection{Definition of Metrics.}
        ...
        \begin{itemize}
            ...
            \item $p_\text{fail}$: Calculated failure probability from BOAST.
...
\subsection{Experiment 7: Prior Strength Derivation} \label{sec:ps_experiment4}
    ...
    \begin{figure}[ht!]
        ...
        \caption{Graphs the true $p_\text{fail}$ values against the reported confidence intervals from BOAST for various $n$ (left) and the width of the confidence intervals against $n$ (right).}
